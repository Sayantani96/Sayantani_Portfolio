...
Click the Create automation button at the top right.</br> </br>
![Screenshot](images/trello-01.png)
</br> </br>
In the Create a Rule page, click the Add Trigger button.</br> </br>
...
For the required trigger condition from the options displayed, add the required conditions.</br> </br>
![Screenshot](images/trello-15.png)
![Screenshot](images/trello-11.png)
</br> </br>
Click the + (plus) icon next to the required trigger to add it to the rule.</br> </br>
...
Click the + (plus) icon next to the action to add it to the rule.</br> </br>
...
Click Card buttons on the left sidebar of your board.</br> </br>
![Screenshot](images/trello-13.png)
</br> </br>
In the Card buttons page click Create button at top right.</br> </br>
...
Once all the configurations are complete, click Add Action. The Select an Action section appears.</br> </br>
![Screenshot](images/trello-07.png)
</br> </br>
Select the appropriate action category.
For the required action from the options displayed, select the relevant conditions.
Click the + (plus) icon next to the required action to add it to the button. The selected action is performed when you click the button.</br> </br>
...
In the Scheduled automations page, click Create automation.</br> </br>
![Screenshot](images/trello-09.png)
</br> </br>
In the Create a scheduled automation page, click Add Trigger.</br> </br>
![Screenshot](images/trello-04.png)
</br> </br>
Choose an appropriate scheduling and select the required schedule conditions.
Click the + (plus) icon next to the required schedule to add it.</br> </br>
![Screenshot](images/trello-19.png)
</br> </br>
Select the appropriate action category.
For the required action from the options displayed, select the relevant conditions.
Click the + (plus) icon next to the required action. The selected action will be performed at the scheduled interval.</br> </br>
